...
Ledger:
  ledger file               File a typed observation in a Project or group ledger
  ledger list               List entries, including an explicitly selected detached ledger
  ledger show               Show an entry with provenance and revision history
  ledger edit               Edit content using the displayed revision
  ledger state              Resolve, archive, or reopen an entry
  ledger review             List advisory triage candidates and available evidence
  ledger revert             Restore earlier editable content as a new revision
  ledger import             Import optional legacy artifacts without overwriting conflicts
