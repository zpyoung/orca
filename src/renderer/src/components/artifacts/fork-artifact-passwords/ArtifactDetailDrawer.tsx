// Forked from src/renderer/src/components/artifacts/ArtifactDetailDrawer.tsx at da585e8b14.
...
import { ArtifactProtectedDetail } from './ArtifactProtectedDetail'
        ...
        {item ? (
          <div className="flex h-full min-h-0 flex-col">
            ...
            <ArtifactDetailHeader
              ...
              onDelete={onDelete}
            />
            {artifactProtectionState(item) && artifactProtectionState(item) !== 'unprotected' ? (
              <ArtifactProtectedDetail key={item.artifact.slug} item={item} />
            ) : (
